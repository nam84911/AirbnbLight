                ...
                children: [
                    {
                        ...
                        path: "new",
                        loadChildren: () => Promise.all(/*! import() | offers-new-offer-new-offer-module */[__webpack_require__.e("default~discover-place-detail-place-detail-module~new-offer-new-offer-module~offers-new-offer-new-of~089e34c1"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null, /*! ./offers/new-offer/new-offer.module */ "./src/app/places/offers/new-offer/new-offer.module.ts")).then(m => m.NewOfferPageModule)
                    },
                    {
                        path: "edit/:placeId",
                        loadChildren: () => __webpack_require__.e(/*! import() | offers-edit-offers-edit-offers-module */ "common").then(__webpack_require__.bind(null, /*! ./offers/edit-offers/edit-offers.module */ "./src/app/places/offers/edit-offers/edit-offers.module.ts")).then(m => m.EditOffersPageModule)
                    }, {
                        path: ":placeId",
                        loadChildren: () => __webpack_require__.e(/*! import() | offers-offer-booking-offer-booking-module */ "common").then(__webpack_require__.bind(null, /*! ./offers/offer-booking/offer-booking.module */ "./src/app/places/offers/offer-booking/offer-booking.module.ts")).then(m => m.OfferBookingPageModule)
                    }
                ]
            }, {
                path: '',
