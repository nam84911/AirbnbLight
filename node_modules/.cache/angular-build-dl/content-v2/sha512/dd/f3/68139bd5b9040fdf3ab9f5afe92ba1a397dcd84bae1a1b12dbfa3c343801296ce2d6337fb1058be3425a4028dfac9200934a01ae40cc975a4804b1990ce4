...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["discover-discover-module"], {
  ...
  function srcAppPlacesDiscoverDiscoverRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~discover-place-detail-place-detail-module~new-offer-new-offer-module~offers-new-offer-new-of~089e34c1"), __webpack_require__.e("default~discover-place-detail-place-detail-module~place-detail-place-detail-module")]).then(__webpack_require__.bind(null,
  ...
  function srcAppPlacesDiscoverDiscoverPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DiscoverPage = /*#__PURE__*/function () {
      function DiscoverPage(placeService, authService) {
      ...
      _createClass(DiscoverPage, [{
        ...
        value: function ionViewWillEnter() {
          ...
          if (this.segment.value == 'all') {
            ...
            this.places = this.allPlaces.filter(function (p) {
              return p.userId != _this.authService.userId;
            });
          }
        ...
        value: function ngOnInit() {
          ...
          this.placesSubscription = this.placeService.places.subscribe(function (places) {
            _this2.allPlaces = places;
            _this2.places = _this2.allPlaces;
          });
        }
      }, {
        key: "onChange",
        value: function onChange(event) {
          ...
          if (event.detail.value == 'all') {
            ...
            this.places = this.allPlaces.filter(function (p) {
              return p.userId != _this3.authService.userId;
            });
          }
        }
      }, {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('segment', {
      "static": true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonSegment"])], DiscoverPage.prototype, "segment", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_place_service__WEBPACK_IMPORTED_MODULE_2__["PlaceService"], src_app_auth_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])], DiscoverPage);
    /***/
  }
}]);
