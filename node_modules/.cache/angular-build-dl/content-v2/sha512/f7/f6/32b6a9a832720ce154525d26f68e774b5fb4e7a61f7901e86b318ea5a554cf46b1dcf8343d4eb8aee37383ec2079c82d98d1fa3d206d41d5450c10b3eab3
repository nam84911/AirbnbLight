...
const routes = [
    ...
    {
        path: 'bookings',
        loadChildren: () => __webpack_require__.e(/*! import() | booking-booking-module */ "booking-booking-module").then(__webpack_require__.bind(null, /*! ./booking/booking.module */ "./src/app/booking/booking.module.ts")).then(m => m.BookingPageModule),
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
];
...
const environment = {
    production: false,
    googleApiKey: "AIzaSyBRQpeJXIV_YWvvM1bCeIC1ko6FqvfHO-A"
};
/*
...
/* harmony import */ var _ionic_pwa_elements_loader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/pwa-elements/loader */ "./node_modules/@ionic/pwa-elements/loader/index.es2017.mjs");
...
module.exports = __webpack_require__(/*! /Users/namdo/Document/ionic/airbnb/src/main.ts */"./src/main.ts");
